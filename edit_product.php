...
<?php
 if(isset($_POST['product'])){
   ...
   if(empty($errors)){
       ...
       $query  .=" name ='{$p_name}', product_id ='{$p_cat}', product_color ='{$p_color}', size_product ='{$p_size}', quantity = '{$p_qty}', buy_price ='{$p_buy}', sale_price ='{$p_sale}'";
        ...
        <div class="panel-body">
         <div class="col-md-7">
           <form method="post" action="edit_product.php?id=<?php echo (int)$products['id'] ?>">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" name="product-size" value="<?php echo remove_junk($products['size_product']); ?>">
                   </div>
                  </div>
                 </div>
                 <div class="col-md-4">
              ...
              <button type="submit" name="product" class="btn btn-success">Update Order</button>
          </form>
         </div>
        </div>
      </div>
